package com.technotechworldz.covid_19tracker.models;

public class urls {
    String india_state_url = "https://api.covidindiatracker.com/state_data.json";           // India all states + all cities state wise data
    String countries_data = "https://covid.ourworldindata.org/data/owid-covid-data.json";   // Data from 31-12-2019 to till date (19-06-2020)
    String data_url = "https://covidtracking.com/api/v1/states/info.json";
}
...
/*
STATE ID CODES USEFUL FOR MAPPING DATA INTO GEOMAPS.
